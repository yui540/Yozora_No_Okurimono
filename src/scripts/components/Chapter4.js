...
import title from '../../images/chapter/title/4.svg'
    ...
    return (
      <div className="chapter chapter-4">
        ...
        <div className="menu__page">
          <Link to="/"><img className="title" src={title} alt="chapter-4" /></Link>
          <div className="content">
            <nav className="nav">
              ...
              <Link className="current" to="/chapter/4"><span>▶︎</span>文字を使った表現に挑戦しよう</Link>
            </nav>
