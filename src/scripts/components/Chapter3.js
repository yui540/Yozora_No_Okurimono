...
import title from '../../images/chapter/title/3.svg'
import virtualNeet from '../../images/chapter/virtual-neet.svg'
import prev from '../../images/chapter/prev.svg'
    ...
    return (
      <div className="chapter chapter-3">
        ...
        <div className="menu__page">
          <Link to="/"><img className="title" src={title} alt="chapter-3" /></Link>
          <div className="content">
            <nav className="nav">
              <div className="label"></div>
              <Link to="/chapter/1"><span>▶︎</span>CSSアニメーションの基本</Link>
              <Link to="/chapter/2"><span>▶︎</span>基本的なアニメーションを作ろう</Link>
              <Link className="current" to="/chapter/3"><span>▶︎</span>画面遷移のアニメーションを作ろう</Link>
