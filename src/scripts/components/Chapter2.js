...
import title from '../../images/chapter/title/2.svg'
    ...
    return (
      <div className="chapter chapter-2">
        ...
        <div className="menu__page">
          <Link to="/"><img className="title" src={title} alt="chapter-2" /></Link>
          <div className="content">
            <nav className="nav">
              <div className="label"></div>
              <Link to="/chapter/1"><span>▶︎</span>CSSアニメーションの基本</Link>
              <Link className="current" to="/chapter/2"><span>▶︎</span>基本的なアニメーションを作ろう</Link>
